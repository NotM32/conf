{ pkgs, ... }:
{
  ...
  accounts.email = {
    ...
    accounts.protonmail = {
      ...
      msmtp.enable = true;
      msmtp.tls.fingerprint = "77:A7:DD:F5:8F:F6:E2:6B:6A:F0:52:29:3C:06:35:0A:23:CE:A1:2D:C8:47:BF:B4:6A:78:08:E5:D8:26:D6:30";
      notmuch.enable = true;
      primary = true;
      ...
      passwordCommand = "${pkgs.gnupg}/bin/gpg -q -d ~/.authinfo.gpg | awk 'FNR == 5 {print $8}'";
      smtp = {
        host = "127.0.0.1";
        port = 1025;
